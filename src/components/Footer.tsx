  ...
  return (
    <footer className="bg-white pt-8 pb-4 border-t border-brand-charcoal/5">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
        ...
        <div>
          <h4 className="text-[10px] font-bold tracking-[0.2em] uppercase text-gray-400 mb-4">Explorar</h4>
        ...
        <div>
          <h4 className="text-[10px] font-bold tracking-[0.2em] uppercase text-gray-400 mb-4">Informação</h4>
          <ul className="space-y-2 text-sm font-sans text-brand-charcoal">
            ...
            <li><a href="https://www.livroreclamacoes.pt/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-red transition-colors text-left">Livro de Reclamações</a></li>
          </ul>
        </div>

        <div>
          <h4 className="text-[10px] font-bold tracking-[0.2em] uppercase text-gray-400 mb-4">Siga-Nos</h4>
          <ul className="space-y-2 text-sm font-sans text-brand-charcoal">
            <li>
            ...
            <li>
              <a href="https://www.instagram.com/socalcos_vinhos_gourmet/" target="_blank" className="flex items-center gap-3 hover:text-brand-red transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8 pt-4 border-t border-gray-100">
